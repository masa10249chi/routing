...
PIPECONF_ID = 'org.onosproject.pipelines.fabric-int'
...
def main(args):
    ...
    collectorIntf1 = Intf( 'veth_11', node=net.nameToNode[ "s204" ] )
    collectorIntf2 = Intf( 'veth_21', node=net.nameToNode[ "s205" ] )
